...
library(dplyr)
setwd('/Users/kumardeepanshuverma/Desktop/R programs')
...
# significant
mydata<-data.frame(data,sep=",")
mydata
mysubdata<-select(data,id,case_in_country,reporting.date)
plot(data$case_in_country,type = 'l',col='blue')
